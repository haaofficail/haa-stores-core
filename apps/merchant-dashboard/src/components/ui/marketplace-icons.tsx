...
export function SallaLogo({ size = 24, ...props }: IconProps) {
  return (
...
export function ZidLogo({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" {...props}>
      <text x="50" y="68" textAnchor="middle" fill="white" fontSize="50" fontWeight="700" fontFamily="system-ui, sans-serif">زد</text>
    </svg>
  );
}

export function NoonLogo({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" {...props}>
      <text x="50" y="65" textAnchor="middle" fill="#1A1A1A" fontSize="42" fontWeight="800" fontFamily="system-ui, sans-serif">noon</text>
    </svg>
  );
}

export function AmazonLogo({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" {...props}>
      <text x="50" y="50" textAnchor="middle" fill="#FF9900" fontSize="20" fontWeight="700" fontFamily="system-ui, sans-serif">amazon</text>
      <path d="M22 62 Q50 72 78 62" stroke="#FF9900" strokeWidth="3" fill="none" strokeLinecap="round" />
      <path d="M22 62 Q20 58 25 56" stroke="#FF9900" strokeWidth="3" fill="none" strokeLinecap="round" />
    </svg>
  );
}
