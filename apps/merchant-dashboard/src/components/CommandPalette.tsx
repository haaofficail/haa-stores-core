...
const COMMANDS: Command[] = [
  ...
  // Settings
  { id: 'settings',          label: 'إعدادات المتجر',        path: '/settings',               icon: 'SettingsIcon',       keywords: 'settings إعدادات', group: 'الإعدادات' },
    ...
    >
      ...
      >
        <div className="relative border-b border-neutral-100">
          <Icon name="Search" size="xs" className="absolute text-neutral-400 top-1/2 -translate-y-1/2" style={{ insetInlineStart: '1rem' }} />
          <input
            ref={inputRef}
            value={query}
        ...
        <div className="px-4 py-2 border-t border-neutral-100 bg-neutral-50 flex items-center justify-between text-xs text-neutral-500">
          <span className="flex items-center gap-1">
            <Icon name="ArrowLeft" size="2xs" /> {t('cmdk.hint.navigate', 'سهم لأعلى/أسفل للتنقل')}
          </span>
