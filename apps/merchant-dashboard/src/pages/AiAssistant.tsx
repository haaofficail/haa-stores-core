        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="relative">
              <div className="w-12 h-12 rounded-3xl bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/20 ring-4 ring-white">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6 relative z-10 scroll-smooth">
        ...
        {!hasStartedChat && (
          <div className="flex flex-col items-center justify-center py-8 text-center animate-in fade-in zoom-in duration-500">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center shadow-2xl shadow-blue-500/30 mb-6 ring-8 ring-blue-100/50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 w-full max-w-2xl">
              {quickActions.map((qa) => (
                ...
                >
                  <div className="mb-3 p-2 rounded-xl bg-blue-50">
        ...
        {messages.map((msg, index) => (
          ...
          >
            {msg.role === 'assistant' && (
              <div className="w-9 h-9 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center flex-shrink-0 mt-1 shadow-md shadow-blue-500/20">
                ...
                <div className="flex flex-wrap gap-2 mt-3 mr-2">
                  {msg.suggestions.map((sug) => (
                    <button
                      ...
                      className="px-3 py-1.5 text-xs rounded-full border border-white/50 bg-white/80 text-neutral-600 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all shadow-sm hover:shadow-md backdrop-blur-xl"
                    >
                ...
                <div className="flex flex-wrap gap-2 mt-3 mr-2">
                  {msg.actions.map((act) => (
                    <Button
                      ...
                      size="sm"
                      variant="outline"
                      className="text-xs h-9 px-4 rounded-full border-blue-200 text-blue-700 bg-white/80 hover:bg-blue-50 backdrop-blur-xl shadow-sm hover:shadow-md transition-all"
                      onClick={() => {
        ...
        {loading && (
          <div className="flex gap-3 animate-in fade-in slide-in-from-bottom-2">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center flex-shrink-0 shadow-md shadow-blue-500/20">
        ...
        <form onSubmit={handleChatSubmit} className="max-w-3xl mx-auto">
          <div className="relative flex items-center">
            <input
              ...
              className="w-full pr-14 pl-5 py-3.5 rounded-3xl bg-white/80 backdrop-blur-xl border border-white/50 text-neutral-900 placeholder:text-neutral-400 text-sm shadow-card focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-300 transition-all"
              disabled={loading}
              dir="rtl"
            />
            <button
              ...
              className="absolute end-2 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white flex items-center justify-center shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 hover:scale-105 active:scale-95 transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
