...
const fulfillmentColors: Record<string, 'default' | 'success' | 'warning' | 'destructive' | 'secondary'> = {
...
const arabicPaymentLabels: Record<string, string> = {
  unpaid: 'غير مدفوع',
...
const arabicFulfillmentLabels: Record<string, string> = {
...
function getArabicLabel(status: string | null | undefined): string | undefined {
...
function StatusBadge({ status, colors, icon, label }: { status: string; colors: Record<string, string>; icon?: React.ReactNode; label?: string }) {
