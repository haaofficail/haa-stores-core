        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/50 shadow-card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold tracking-tight text-neutral-900 mt-1">{formatCurrency(salesSummary?.totalSales ?? 0)} <SarIcon size="sm" /></p>
            </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/50 shadow-card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold tracking-tight text-neutral-900 mt-1">{formatCurrency(salesSummary?.averageOrderValue ?? 0)} <SarIcon size="sm" /></p>
            </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/50 shadow-card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold tracking-tight text-neutral-900 mt-1">{formatCurrency(walletSummary?.netBalance ?? 0)} <SarIcon size="sm" /></p>
            </div>
