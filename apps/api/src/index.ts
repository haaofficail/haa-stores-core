...
import { bankTransferRouter } from './routes/bank-transfer.js';
...
app.route('/merchant/:storeId/orders', bankTransferRouter);
...
app.route('/merchant/:storeId/whatsapp', whatsappRouter);
