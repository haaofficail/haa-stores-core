...
async function seed() {
  ...
  if (existingTenant.length > 0) {
    ...
    const templates = [
      ...
      { code: 'payout_requested', name: 'طلب تسوية مستلم', channel: 'email', subjectTemplate: 'تم استلام طلب تسويتك #{{reference}}', bodyTemplate: 'مرحباً،\n\nتم استلام طلب تسويتك بمبلغ {{amount}} {{currency}}.\n\nرقم المرجع: {{reference}}\n\nسيتم مراجعة الطلب خلال 1-3 أيام عمل.' },
      { code: 'payout_approved', name: 'موافقة على طلب التسوية', channel: 'email', subjectTemplate: 'تمت الموافقة على طلب تسويتك #{{reference}}', bodyTemplate: 'مرحباً،\n\nتمت الموافقة على طلب تسويتك بمبلغ {{amount}} {{currency}}.\n\nرقم المرجع: {{reference}}\n\nسيتم تحويل المبلغ إلى حسابك البنكي خلال 1-2 أيام عمل.' },
      { code: 'payout_rejected', name: 'رفض طلب التسوية', channel: 'email', subjectTemplate: 'بخصوص طلب تسويتك #{{reference}}', bodyTemplate: 'مرحباً،\n\nنأسف لإعلامك بأنه تعذّر معالجة طلب تسويتك بمبلغ {{amount}} {{currency}}.\n\nالسبب: {{reason}}\n\nيمكنك تقديم طلب جديد بعد مراجعة البيانات.' },
      { code: 'payout_transferred', name: 'تم تحويل التسوية', channel: 'email', subjectTemplate: 'تم تحويل مبلغ التسوية #{{reference}}', bodyTemplate: 'مرحباً،\n\nيسعدنا إعلامك بأنه تم تحويل مبلغ {{amount}} {{currency}} إلى حسابك البنكي.\n\nرقم المرجع: {{reference}}\nتاريخ التحويل: {{transferredAt}}\n\nشكراً لثقتك بنا.' },
    ];
