...
export const THEMES: ThemeDefinition[] = [
  {
    ...
    tags: ['خفيف', 'سريع', 'عصري'],
    screenshotUrl: thumb({ primary: '#5c9cd5', surface1: '#ffffff', surface2: '#f8f9fa', surface3: '#f1f3f5', textPrimary: '#1a1a1a', textSecondary: '#6b7280', textTertiary: '#9ca3af', border: '#e5e7eb', borderHover: '#d1d5db', success: '#10b981', warning: '#f59e0b', error: '#ef4444', headerBackground: '#ffffff', headerText: '#4b5563', announcementBackground: '#5c9cd5', announcementText: '#ffffff' }),
    demoUrl: undefined,
    config: {
      preset: 'minimal',
      colors: { primary: '#5c9cd5', surface1: '#ffffff', surface2: '#f8f9fa', surface3: '#f1f3f5', textPrimary: '#1a1a1a', textSecondary: '#6b7280', textTertiary: '#9ca3af', border: '#e5e7eb', borderHover: '#d1d5db', success: '#10b981', warning: '#f59e0b', error: '#ef4444', headerBackground: '#ffffff', headerText: '#4b5563', announcementBackground: '#5c9cd5', announcementText: '#ffffff' },
