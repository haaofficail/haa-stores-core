...
4. المسوغ النظامي
نعالج البيانات الشخصية عند الحاجة لتنفيذ طلبات الشراء والتوصيل، أو للوفاء بالتزامات نظامية، أو بناءً على موافقة صاحب البيانات في الحالات التي تتطلب ذلك.
...
لصاحب البيانات الحق في الوصول إلى بياناته الشخصية، وتصحيحها، وطلب إتلافها أو حذفها عند انتفاء الحاجة النظامية للاحتفاظ بها، وممارسة حقوقه عبر وسائل التواصل الموضحة أدناه. يُرد على الطلبات خلال 30 يومًا.

8. مدة الاحتفاظ والإتلاف
نحتفظ بالبيانات طوال مدة نشاط حسابك في المتجر، ولمدة خمس سنوات بعد آخر معاملة أو حسب ما تتطلبه الأنظمة ذات العلاقة، ثم تُحذف أو تُتلف بطريقة آمنة متى انتفت الحاجة النظامية للاحتفاظ بها.
...
5. الشحن والتوصيل
تتم أوقات التوصيل وفق ما هو مُعلن في سياسة الشحن. يتحمل العميل تكلفة الشحن ما لم يُنص على خلاف ذلك. يحق للعميل إلغاء الطلب إذا تأخر التسليم أو التنفيذ لأكثر من 15 يومًا من تاريخ التعاقد ما لم يكن التأخير بسبب قوة قاهرة أو اتفاق مختلف واضح مع العميل.
...
5. التأخير
في حالة التأخر عن الوقت المتوقع، سيتم إشعارك فورًا. يحق للعميل إلغاء الطلب إذا تأخر التسليم أو التنفيذ لأكثر من 15 يومًا من تاريخ التعاقد ما لم يكن التأخير بسبب قوة قاهرة أو اتفاق مختلف واضح مع العميل.

6. العنوان
يجب أن يكون عنوان التوصيل دقيقًا وكاملًا. لا يتحمل المتجر مسؤولية التأخير الناتج عن عنوان غير صحيح.`;
...
3. عملية الإرجاع
- يتواصل العميل مع خدمة العملاء لطلب الإرجاع.
...
6. التكاليف
يتحمل العميل تكلفة الشحن في حالة الإرجاع، إلا إذا كان سبب الإرجاع خطأ في المنتج أو عيبًا أو عدم مطابقة للوصف.`;
