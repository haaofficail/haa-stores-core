...
import React, { forwardRef, useCallback, useState, type ElementRef, type ComponentPropsWithoutRef } from 'react'
      ...
      >
        <span
          style={{
            ...
            transition: 'left var(--duration-fast) var(--ease-spring-snappy)',
