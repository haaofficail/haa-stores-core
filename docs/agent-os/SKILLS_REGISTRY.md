...
2. Pick **every applicable skill** from the matching row(s) below and from
   `docs/agent-os/SKILL_FILE_MAPPING.md`. There is no numeric cap; do not pad
   the gate with unrelated skills.
