...
**TASK-0131 — Admin Store Payment Settings save contract is open in PR #341 (2026-06-30).**

Branch: `codex/admin-store-payment-typed-cache`. PR: #341.
...
full `pnpm -r typecheck`. Remaining work: remote checks, merge, and staging
smoke. Do not stage `storage/monitoring-events.ndjson`; it was generated by
required local monitoring and is outside this scope.
