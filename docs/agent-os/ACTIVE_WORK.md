...
Branch: `codex/merchant-whatsapp-e2e-slice`. PR: pending.
...
`git diff --check` was clean, and `pnpm preflight` passed. Draft PR creation
and remote check review are still pending.
