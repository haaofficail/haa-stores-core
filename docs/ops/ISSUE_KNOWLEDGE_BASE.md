...
- **Status:** TASK-0146 workflow cutover is ready for staging deploy verification. The `haa-staging` self-hosted runner is online; next step is merging PR #355 and confirming the deploy job runs on the VPS runner.
