...
- **Acceptance Criteria:**
  - [x] Staging migration workflow dry-run reads `drizzle.__drizzle_migrations` and reports pending migrations without DB writes.
